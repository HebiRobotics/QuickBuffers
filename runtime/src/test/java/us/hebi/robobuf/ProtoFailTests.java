...
public class ProtoFailTests {
    ...
    @Test(expected = ProtoOutput.OutOfSpaceException.class)
    ...
    private void writeToTruncated(ProtoMessage msg) throws IOException {
        ...
        ProtoOutput output = ProtoOutput.newInstance(buffer);
        msg.writeTo(output);
    }
    ...
    private void readFromTruncated(ProtoMessage msg) throws IOException {
        ...
        ProtoInput input = ProtoInput.newInstance(data, 0, length);
