...
class RuntimeApi {
    ...
    static final ClassName InputBuffer = ClassName.get(API_PACKAGE, "ProtoInputBuffer");
    static final ClassName OutputBuffer = ClassName.get(API_PACKAGE, "ProtoOutputBuffer");
