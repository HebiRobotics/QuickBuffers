...
public class TypeMapTest {
    ...
    public void testSimpleTypeMap() {
        ...
        assertEquals("us.hebi.robobuf.test.Simple.SimpleMessage", map.resolveClassName(".robobuf_unittest_import.SimpleMessage").toString());
    }
    ...
    public void testImportTypeMap() {
        ...
        assertEquals("us.hebi.robobuf.test.ContainerMessage", map.resolveClassName(".robobuf_unittest.ContainerMessage").toString());
        ...
        String typeId = request
                ...
                .getTypeName();
        assertEquals("us.hebi.robobuf.test.external.ImportMessage.NestedImportMessage", map.resolveClassName(typeId).toString());
