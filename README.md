...
* Download [protoc-gen-quickbuf](https://github.com/HebiRobotics/QuickBuffers/releases/download/1.0-alpha9/protoc-gen-quickbuf-1.0-alpha9.zip) and extract the files into the same directory or somewhere else on the `$PATH`.
                ...
                <execution>
                    ...
                    <configuration>
                        <tasks>
                            ...
                            <get src="https://github.com/HebiRobotics/QuickBuffers/releases/download/1.0-alpha9/protoc-gen-quickbuf-1.0-alpha9.zip"
